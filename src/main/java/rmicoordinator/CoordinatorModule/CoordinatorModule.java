package rmicoordinator.CoordinatorModule;

import rmiserver.Implementation.Coordinator;
...
public class CoordinatorModule extends UnicastRemoteObject {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("rmiserver.File started storage at "+ RMI_COORDINATOR);
